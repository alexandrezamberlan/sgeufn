...
class EventoForm(forms.ModelForm):
    ...
    class Meta:
        model = Evento
        fields = ['nome', 'tipo', 'descricao', 'carga_horaria', 'local', 'lotacao', 'site', 'instituicao', 'coordenador', 'email', 'data_inicio', 'data_inscricao', 'frequencia_liberada', 'codigo_frequencia', 'is_active']
